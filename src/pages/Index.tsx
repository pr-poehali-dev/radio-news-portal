...
const schedule = [
  { time: "07:00", show: "Утренний эфир", host: "Максим Орлов" },
  { time: "10:00", show: "Музыкальный час", host: "Анна Светлова" },
  { time: "13:00", show: "Дневной блок", host: "Дмитрий Коваль" },
  { time: "16:00", show: "Горячие новинки", host: "Юлия Морева" },
  { time: "19:00", show: "Вечерний эфир", host: "Игорь Зайцев" },
  { time: "22:00", show: "Ночная волна", host: "Ксения Лунёва" },
];
    ...
    <div>
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 60% 50%, rgba(232,68,26,0.08) 0%, transparent 70%)",
          }}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative">
          <div className="max-w-2xl animate-fade-up">
            ...
            <h1
              className="font-display text-5xl md:text-7xl uppercase leading-none mb-4"
            ...
            >
              Музыка, которая создаёт начала. Живой поток, новости и конкурсы — всё на одной волне.
            </p>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-1">
            {schedule.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-4 px-4 py-3 rounded-lg card-hover"
                style={{ background: "var(--radio-surface)" }}
              >
                <span
                  className="font-display text-sm w-12 shrink-0"
                  style={{ color: "var(--radio-red)" }}
                >
                  {item.time}
                </span>
            ...
            {latestNews.map((n) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  <span
                    className="text-xs font-display tracking-wide uppercase"
                    style={{ color: "var(--radio-red)" }}
                  >
                    {n.category}
                  </span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            { to: "/votes", icon: "BarChart2", label: "Голосования" },
            ...
            <Link
              key={item.to}
              to={item.to}
              className="flex items-center gap-3 px-5 py-4 rounded-xl card-hover border"
              style={{
